...
function solucionCubo(){
        ...
        cicloMemo: do {
            ...
            for (var posible in posibles(haciaColor)) {
                ...
                if ((haciaColorTemp2 == haciaColor2 && haciaColorTemp3 == haciaColor3)
                    ...
                    letrasMemo.push(posibles(haciaColor)[posible]);
    ...
    zz=1;
    esquinasMemoT=letrasMemo.length;

     for (yy = 1; zz < esquinasMemoT; yy++){
         zz=zz+1;
        if (letrasMemo[yy] == letrasMemo[yy-1]){
            esquinaRepetida = letrasMemo[yy];
            esquinaRepetida1 = letrasMemo[yy-1];
              letrasMemo.remove(esquinaRepetida);
              letrasMemo.remove(esquinaRepetida1);
              yy=yy-2;
        }
    ...
    zz=1;
    aristasMemoT=letrasMemo.length;

     for (yy = 1; zz < aristasMemoT; yy++){
         zz=zz+1;
        if (letrasMemo[yy] == letrasMemo[yy-1]){
            aristaRepetida = letrasMemo[yy];
            aristaRepetida1 = letrasMemo[yy-1];
              letrasMemo.remove(aristaRepetida);
              letrasMemo.remove(aristaRepetida1);
              yy=yy-2;
        }
